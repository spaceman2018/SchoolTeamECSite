...
public class PurchaseHistoryInfoDAO {
	public int regist(String loginId, int productId, int productCount, int destinationId, int subtotal) {
	...
	public List<PurchaseHistoryInfoDTO> getHistory(String loginId) {
		DBConnector db =new DBConnector();
		Connection con = db.getConnection();
		List<PurchaseHistoryInfoDTO> list = new ArrayList<PurchaseHistoryInfoDTO>();
		String sql = "SELECT"
				+ " phi.id as id,"
